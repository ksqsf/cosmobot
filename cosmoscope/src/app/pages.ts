...
export type PageCapability = LiveAdminMethod
...
export const pages = [
  ...
  { name: 'threads', path: '/threads/:threadId?', title: 'Threads', icon: 'pi pi-sitemap', requiredCapabilities: ['thread.list', 'thread.get', 'thread.resolve_run', 'thread.active', 'thread.halt', 'audit.run', 'audit.thread', 'audit.subscribe'], component: () => import('@/pages/ThreadsPage.vue') },
  ...
  { name: 'audit', path: '/audit/:auditId?', title: 'Audit', icon: 'pi pi-wave-pulse', requiredCapabilities: ['audit.recent', 'audit.search', 'audit.get', 'audit.run', 'audit.thread', 'audit.subscribe', 'thread.get'], component: () => import('@/pages/AuditPage.vue') },
  ...
  { name: 'schedules', path: '/schedules/:scheduleId?', title: 'Schedules', icon: 'pi pi-calendar-clock', requiredCapabilities: ['schedule.list', 'schedule.delete'], component: () => import('@/pages/SchedulesPage.vue') },
