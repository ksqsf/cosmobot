...
export const pages = [
  { name: 'overview', path: '/overview', title: 'Overview', icon: 'pi pi-home', requiredCapabilities: ['concurrency.list', 'audit.recent', 'chat.list_sessions', 'resource.list'], component: () => import('@/pages/OverviewPage.vue') },
