...
export const pages = [
  ...
  { name: 'threads', path: '/threads/:threadId?', title: 'Threads', icon: 'pi pi-sitemap', requiredCapabilities: ['thread.list', 'thread.get', 'thread.active', 'thread.halt', 'audit.thread_messages'], component: () => import('@/pages/ThreadsPage.vue') },
