...
type DemoCapability = 'resources.demo' | 'plugins.demo' | 'logs.demo' | 'config.demo'
...
export const pages = [
  ...
  { name: 'chat', path: '/chat/:sessionId?', title: 'Chat', icon: 'pi pi-comments', navigationGroup: 'workspace', requiredCapabilities: chatMethods, component: () => import('@/pages/ChatPage.vue') },
  { name: 'audit', path: '/audit/:auditId?', title: 'Audit', icon: 'pi pi-wave-pulse', navigationGroup: 'workspace', requiredCapabilities: ['audit.recent', 'audit.get', 'audit.thread', 'audit.subscribe'], component: () => import('@/pages/AuditPage.vue') },
