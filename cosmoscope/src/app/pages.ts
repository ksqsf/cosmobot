...
export const pages = [
  ...
  { name: 'threads', path: '/threads/:threadId?', title: 'Threads', icon: 'pi pi-sitemap', requiredCapabilities: ['thread.list', 'thread.get', 'thread.resolve_run', 'thread.active', 'thread.halt', 'audit.thread'], component: () => import('@/pages/ThreadsPage.vue') },
